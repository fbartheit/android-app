...
/**
 * Created by Dragan on 9/28/2016.
 */
public class GPSTracker extends Service implements LocationListener {
    ...
    private FirstFixListener firstFixListener = new MyFirstFixListener();
    private LocationUpdateListener locationUpdateListener = new MyLocationUpdateListener();
    ...
    private class MyLocationUpdateListener implements LocationUpdateListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            if (previousLocation != null) {
                ...
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(new Intent(LocationUpdatedBroadcastReceiver.LOCATION_UPDATED_BROADCAST));
            }
        }
